...
openssl s_client -connect <Workspace ID>.oms.opinsights.azure.com:443 -tls1_2 -v

## 2. openssl for TLS v1.3
openssl s_client -connect google.com:443 -tls1_3
openssl s_client -connect <Workspace ID>.oms.opinsights.azure.com:443 -tls1_3 -v
