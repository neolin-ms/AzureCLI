...
# Step.1 Create the name of your Azure Container Registry,and integration with AKS cluster. 
...
# Step.2 Use TLS with your own certificates (https://docs.microsoft.com/en-us/azure/aks/ingress-own-tls?tabs=azure-cli)
...
# Step.3 Create an ingress controller
...
# Step.4 Create Kubernetes secret for the TLS certificate
...
# Step.5 Run only one demo application and create ingress route(https://docs.microsoft.com/en-us/azure/aks/ingress-own-tls?tabs=azure-cli#run-demo-applications)
...
# Step.6 (optional)Run two demo applications and create ingress route(https://docs.microsoft.com/en-us/azure/aks/ingress-own-tls?tabs=azure-cli#run-demo-applications)
